...
#include <QtCore>
double pcs_control_pe = 0;
double pcs_reset_pe = 0;
double pcs_control_time_local_pe = 0;
PCSLink_pe::PCSLink_pe(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::PCSLink_pe)
{
    ui->setupUi(this);
}
PCSLink_pe::~PCSLink_pe()
{
    delete ui;
}
void PCSLink_pe::setPCSData(QString pcs_ip, QString pcs_port, QString pcs_id, QString PCS_eid)
{
...
void PCSLink_pe::on_buttonBox_accepted()
{
...
void PCSLink_pe::PCSdataupdate_slots(double *pcsdata)
{
...
void PCSLink_pe::on_pushButton_pressed()
{
    pcs_control_pe = 1;
    pcs_reset_pe = 0;
    pcs_control_time_local_pe = QDateTime::currentDateTime().toMSecsSinceEpoch();
    emit send_control(pcs_control_pe, pcs_reset_pe, pcs_control_time_local_pe);
}

void PCSLink_pe::on_pushButton_2_pressed()
{
    pcs_control_pe = 2;
    pcs_reset_pe = 0;
    pcs_control_time_local_pe = QDateTime::currentDateTime().toMSecsSinceEpoch();
...
void PCSLink_pe::on_pushButton_3_pressed()
{
    pcs_control_pe = 0;
    pcs_reset_pe = 1;
    pcs_control_time_local_pe = QDateTime::currentDateTime().toMSecsSinceEpoch();;
